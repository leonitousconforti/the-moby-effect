...
```ts
export declare const layer: Layer.Layer<Sessions, never, HttpClient.HttpClient.Service>
```
...
```ts
export declare const make: Effect.Effect<SessionsImpl, never, HttpClient.HttpClient.Service>
```
