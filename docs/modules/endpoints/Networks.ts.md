...
```ts
export declare const layer: Layer.Layer<Networks, never, HttpClient.HttpClient.Default>
```
...
```ts
export declare const make: Effect.Effect<NetworksImpl, never, HttpClient.HttpClient.Default>
```
