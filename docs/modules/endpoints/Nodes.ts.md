...
```ts
export declare const layer: Layer.Layer<Nodes, never, HttpClient.HttpClient.Service>
```
...
```ts
export declare const make: Effect.Effect<NodesImpl, never, HttpClient.HttpClient.Service>
```
