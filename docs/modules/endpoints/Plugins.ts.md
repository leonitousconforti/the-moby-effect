...
```ts
export declare const layer: Layer.Layer<Plugins, never, HttpClient.HttpClient.Default>
```
...
```ts
export declare const make: Effect.Effect<PluginsImpl, never, HttpClient.HttpClient.Default>
```
