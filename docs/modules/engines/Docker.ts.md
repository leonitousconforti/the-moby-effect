...
```ts
export declare const layerBun: (connectionOptions: PlatformAgents.MobyConnectionOptions) => Moby.MobyLayer
```
...
```ts
export declare const layerDeno: (connectionOptions: PlatformAgents.MobyConnectionOptions) => Moby.MobyLayer
```
...
```ts
export declare const layerNodeJS: (connectionOptions: PlatformAgents.MobyConnectionOptions) => Moby.MobyLayer
```
...
```ts
export declare const layerUndici: (connectionOptions: PlatformAgents.MobyConnectionOptions) => Moby.MobyLayer
```
