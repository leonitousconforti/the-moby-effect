...
export class SwarmContainerSpec extends Schema.Class<SwarmContainerSpec>("SwarmContainerSpec")(
    {
        ...
        Secrets: Schema.optional(Schema.Array(MobySchemasGenerated.SwarmSecretReference), { nullable: true }),
        Configs: Schema.optional(Schema.Array(MobySchemasGenerated.SwarmConfigReference), { nullable: true }),
