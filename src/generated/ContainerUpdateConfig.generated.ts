...
export class ContainerUpdateConfig extends Schema.Class<ContainerUpdateConfig>("ContainerUpdateConfig")(
    {
    ...
    {
        identifier: "ContainerUpdateConfig",
        title: "container.UpdateConfig",
    }
) {}
