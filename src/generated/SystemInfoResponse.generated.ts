...
export class SystemInfoResponse extends Schema.Class<SystemInfoResponse>("SystemInfoResponse")(
    {
        ...
        Plugins: MobySchemasGenerated.PluginsInfo,
        ...
        Runtimes: Schema.NullOr(Schema.Record(Schema.String, MobySchemasGenerated.Runtime)),
        ...
        ContainerdCommit: MobySchemasGenerated.Commit,
        RuncCommit: MobySchemasGenerated.Commit,
        InitCommit: MobySchemasGenerated.Commit,
        SecurityOptions: Schema.NullOr(Schema.Array(Schema.String)),
        ProductLicense: Schema.optional(Schema.String),
        DefaultAddressPools: Schema.optional(Schema.Array(MobySchemasGenerated.NetworkAddressPool), { nullable: true }),
