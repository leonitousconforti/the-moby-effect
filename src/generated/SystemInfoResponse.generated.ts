...
export class SystemInfoResponse extends Schema.Class<SystemInfoResponse>("SystemInfoResponse")(
    {
        ...
        Plugins: MobySchemasGenerated.SystemPluginsInfo,
        ...
        GenericResources: Schema.NullOr(Schema.Array(MobySchemasGenerated.SwarmGenericResource)),
        ...
        Runtimes: Schema.NullOr(Schema.Record(Schema.String, MobySchemasGenerated.SystemRuntimeWithStatus)),
        DefaultRuntime: Schema.String,
        Swarm: MobySchemasGenerated.SwarmInfo,
        LiveRestoreEnabled: Schema.Boolean,
        Isolation: Schema.String,
        InitBinary: Schema.String,
        ContainerdCommit: MobySchemasGenerated.SystemCommit,
        RuncCommit: MobySchemasGenerated.SystemCommit,
        InitCommit: MobySchemasGenerated.SystemCommit,
        SecurityOptions: Schema.NullOr(Schema.Array(Schema.String)),
        ProductLicense: Schema.optional(Schema.String),
        DefaultAddressPools: Schema.optional(Schema.Array(MobySchemasGenerated.SystemNetworkAddressPool), {
            nullable: true,
        }),
