...
export class TypesDiskUsage extends Schema.Class<TypesDiskUsage>("TypesDiskUsage")(
    {
        LayersSize: Schema.BigIntFromString.check(Schema.isBetweenBigInt({ minimum: -(2n ** 63n), maximum: 2n ** 63n - 1n })),
        ...
        BuilderSize: Schema.optional(Schema.BigIntFromString.check(Schema.isBetweenBigInt({ minimum: -(2n ** 63n), maximum: 2n ** 63n - 1n }))),
    },
    {
