...
export class ImageManifestSummary extends Schema.Class<ImageManifestSummary>("ImageManifestSummary")(
    {
        ...
        Size: Schema.Struct({
        Content: Schema.BigIntFromString.check(Schema.isBetweenBigInt({ minimum: -(2n ** 63n), maximum: 2n ** 63n - 1n })),
        Total: Schema.BigIntFromString.check(Schema.isBetweenBigInt({ minimum: -(2n ** 63n), maximum: 2n ** 63n - 1n })),
})
,
    ...
    },
    {
        ...
        documentation: "https://pkg.go.dev/github.com/docker/docker@v28.4.0+incompatible/api/types/image#ManifestSummary",
    }
) {}
