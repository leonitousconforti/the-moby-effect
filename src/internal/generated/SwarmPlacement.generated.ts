...
export class SwarmPlacement extends Schema.Class<SwarmPlacement>("SwarmPlacement")(
    {
        ...
        Preferences: Schema.optional(Schema.NullOr(Schema.Array(Schema.NullOr(SwarmPlacementPreference.SwarmPlacementPreference)))),
        MaxReplicas: Schema.optional(Schema.BigIntFromString.check(Schema.isBetweenBigInt({ minimum: 0n, maximum: 2n ** 64n - 1n }))),
