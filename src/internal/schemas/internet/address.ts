 ...
 * @category Schemas
 */
export class AddressString extends Schema.Union(IPv4.IPv4String, IPv6.IPv6String).annotations({
 ...
 * @see {@link IPv6.IPv6}
 */
export class Address extends Schema.Union(IPv4.IPv4, IPv6.IPv6).annotations({
    identifier: "Address",
 ...
 * @category Schemas
 */
export class AddressBigint extends Schema.Union(IPv4.IPv4Bigint, IPv6.IPv6Bigint).annotations({
