...
const RequiredField = <A, I, R>(schema: Schema.Schema<A, I, R>) => {
    if (
        schema.ast._tag === "ObjectKeyword" ||
        ("records" in schema && "key" in schema && "value" in schema) ||
 ...
 * @since 1.45.0
 */
export class GenericResources extends Schema.Class<GenericResources>("GenericResources")({
...
export class ContainerConfig extends Schema.Class<ContainerConfig>("ContainerConfig")({
     ...
     * `{"<port>/<tcp|udp|sctp>": {}}`
     */
    ExposedPorts: NullableNonRequiredField(Schema.Record(Schema.String, Schema.Object)),
     ...
     * objects.
     */
    Volumes: NullabilityOmittedNonRequiredField(Schema.Record(Schema.String, Schema.Object)),
...
export class ResourceObject extends Schema.Class<ResourceObject>("ResourceObject")({
    ...
    GenericResources: NullableNonRequiredField(Schema.Array(GenericResources)),
}) {}
            ...
            Configs: NullabilityOmittedNonRequiredField(
                Schema.Array(
                    Schema.Struct({
                         ...
                         * mutually exclusive
                         */
                        Runtime: NullabilityOmittedNonRequiredField(Schema.Object),
...
export class SystemInfo extends Schema.Class<SystemInfo>("SystemInfo")({
    ...
    GenericResources: NullabilityOmittedNonRequiredField(Schema.Array(GenericResources)),
...
export class ClusterVolumeSpec extends Schema.Class<ClusterVolumeSpec>("ClusterVolumeSpec")({
    ...
    AccessMode: NullabilityOmittedNonRequiredField(
        Schema.Struct({
            ...
            MountVolume: NullabilityOmittedNonRequiredField(Schema.Object),
...
export class Volume extends Schema.Class<Volume>("Volume")({
     ...
     */
    Status: NullabilityOmittedNonRequiredField(Schema.Record(Schema.String, Schema.Object)),
    ...
    Options: NullabilityOmittedRequiredField(Schema.Record(Schema.String, Schema.String)),
...
export class Task extends Schema.Class<Task>("Task")({
    ...
    NodeID: NullabilityOmittedNonRequiredField(Schema.String),
    AssignedGenericResources: NullabilityOmittedNonRequiredField(Schema.Array(GenericResources)),
